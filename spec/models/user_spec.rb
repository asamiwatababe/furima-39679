  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'first_nameが全角ひらがな、漢字、カタカナ以外の文字を含む場合、登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First name は全角ひらがな、漢字、カタカナで入力してください")
      end
      ...
      it 'last_nameが全角ひらがな、漢字、カタカナ以外の文字を含む場合、登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name は全角ひらがな、漢字、カタカナで入力してください")
      end
      ...
      it 'パスワードが半角英字のみでは登録できないこと' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Password は半角英字と数字を組み合わせて入力してください")
      end
